...
### <span className="not-italic">🎥</span> Production training at Wood Norton
...
### <span className="not-italic">🤖</span> Hands-on with mind-blowing tech
...
### <span className="not-italic">🍻</span> Life at uni
